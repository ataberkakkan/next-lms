...
import { AdminCourseSingularType } from "@/app/data/admin/get-admin-course";
  ...
  function handleDragEnd(event: DragEndEvent) {
      ...
      if (courseId) {
        ...
        toast.promise(reorderChaptersPromise(), {
          ...
          error: () => {
            ...
            return "Failed to reorded chapters";
          },
        });
      }
      return;
    ...
    if (activeType === "lesson" && overType === "lesson") {
      ...
      if (!chapterId || chapterId !== overChapterId) {
        toast.error(
          "Moving lesson between different chapters or invalid Chapter ID is not allowed."
        );
